CREATE TABLE detail_anime (
  ...
  total_episode     int NULL, 
  duration          int NULL, 
  sysnopsis         varchar(max) NULL, 
...
EXEC sp_addextendedproperty 
  @NAME = N'MS_Description', @VALUE = N'manga/anime/original/novel', 
  @LEVEL0TYPE = N'Schema', @LEVEL0NAME = N'dbo', 
  @LEVEL1TYPE = N'Table', @LEVEL1NAME = N'detail_anime', 
  @LEVEL2TYPE = N'Column', @LEVEL2NAME = N'source_type';
EXEC sp_addextendedproperty 
  @NAME = N'MS_Description', @VALUE = N'0 = Pending ( belum diriview)
1 = Udah di review', 
  @LEVEL0TYPE = N'Schema', @LEVEL0NAME = N'dbo', 
  @LEVEL1TYPE = N'Table', @LEVEL1NAME = N'detail_anime', 
  @LEVEL2TYPE = N'Column', @LEVEL2NAME = N'status_review';
EXEC sp_addextendedproperty 
  @NAME = N'MS_Description', @VALUE = N'0 = pending
1 = ditolak
2 = diterima', 
  @LEVEL0TYPE = N'Schema', @LEVEL0NAME = N'dbo', 
  @LEVEL1TYPE = N'Table', @LEVEL1NAME = N'detail_anime', 
  @LEVEL2TYPE = N'Column', @LEVEL2NAME = N'status_confirm';
CREATE TABLE detail_anime_master_characters (
  id                  varchar(50) NOT NULL, 
  detail_anime_id     varchar(50) NOT NULL, 
  master_character_id varchar(50) NOT NULL, 
  master_people_id    varchar(50) NOT NULL, 
  is_active           int NOT NULL, 
  role_character      int NULL, 
  PRIMARY KEY (id, 
  detail_anime_id, 
  master_character_id, 
  master_people_id));
CREATE TABLE detail_anime_master_people (
  id               varchar(50) NOT NULL, 
  detail_anime_id  varchar(50) NOT NULL, 
  master_people_id varchar(50) NOT NULL, 
  is_active        int NOT NULL, 
...
2 finished airing', 
  @LEVEL0TYPE = N'Schema', @LEVEL0NAME = N'dbo', 
  @LEVEL1TYPE = N'Table', @LEVEL1NAME = N'master_anime', 
  @LEVEL2TYPE = N'Column', @LEVEL2NAME = N'airing_status';
EXEC sp_addextendedproperty 
  @NAME = N'MS_Description', @VALUE = N'
TV - Television Series (usually aired on TV at some point in time)
...
CREATE TABLE user_anime_list (
  id                   varchar(50) NOT NULL, 
  master_animeanime_id varchar(50) NOT NULL, 
  master_useruser_id   varchar(50) NOT NULL, 
  status               int NULL, 
  score                int NULL, 
  episode_progress     int NULL, 
  start_date           date NULL, 
  finish_date          date NULL, 
  notes                varchar(50) NULL, 
  PRIMARY KEY (id, 
  master_animeanime_id, 
  master_useruser_id));
...
ALTER TABLE detail_anime_master_characters ADD CONSTRAINT FKdetail_ani92095 FOREIGN KEY (detail_anime_id) REFERENCES detail_anime (detail_anime_id);
ALTER TABLE detail_anime_master_characters ADD CONSTRAINT FKdetail_ani245492 FOREIGN KEY (master_character_id) REFERENCES master_characters (character_id);
ALTER TABLE detail_anime_master_people ADD CONSTRAINT FKdetail_ani428667 FOREIGN KEY (detail_anime_id) REFERENCES detail_anime (detail_anime_id);
ALTER TABLE detail_anime_master_people ADD CONSTRAINT FKdetail_ani49179 FOREIGN KEY (master_people_id) REFERENCES master_people (people_id);
ALTER TABLE detail_anime_master_characters ADD CONSTRAINT FKdetail_ani385751 FOREIGN KEY (master_people_id) REFERENCES master_people (people_id);
...
ALTER TABLE user_anime_list ADD CONSTRAINT FKuser_anime237147 FOREIGN KEY (master_animeanime_id) REFERENCES master_anime (anime_id);
ALTER TABLE user_anime_list ADD CONSTRAINT FKuser_anime440263 FOREIGN KEY (master_useruser_id) REFERENCES master_user (user_id);
